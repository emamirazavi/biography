...
$builder->setBackgroundColor(197, 1, 255);
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top"><?php echo $config['name']; ?></a>
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img class="masthead-avatar mb-5" src="<?php echo $config['avatar']; ?>" alt="..." />
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0"><?php echo $config['job_title']; ?></h1>
            <!-- Icon Divider-->
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0"><?php echo implode(' - ', $config['skills']); ?></p>
        </div>
    </header>
    ...
    <section class="page-section portfolio" id="portfolio">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <!-- Portfolio Item 1-->
                <?php foreach($config['portfolios'] as $key => $portfolio):?>
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal<?php echo $key;?>">
                        <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                            <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
                        </div>
                        <img class="img-fluid" src="<?php echo $portfolio['src'];?>" alt="..." />
                    </div>
                </div>
                <?php endforeach;?>
            </div>
    ...
    <!-- Portfolio Modals-->
    <?php foreach($config['portfolios'] as $key => $portfolio):?>
    <!-- Portfolio Modal <?php echo $key;?>-->
    <div class="portfolio-modal modal fade" id="portfolioModal<?php echo $key;?>" tabindex="-1" aria-labelledby="portfolioModal<?php echo $key;?>" aria-hidden="true">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0"><?php echo $portfolio['title'];?></h2>
                                <!-- Icon Divider-->
                                <div class="divider-custom">
                                    <div class="divider-custom-line"></div>
                                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                                ...
                                <img class="img-fluid rounded mb-5" src="<?php echo $portfolio['src'];?>" alt="..." />
                                <!-- Portfolio Modal - Text-->
                                <p class="mb-4"><?php echo $portfolio['desc'];?></p>
