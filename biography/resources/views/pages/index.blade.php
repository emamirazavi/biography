...
if (isset($_POST['submitButton'])) {
    try {
        ...
        $mail->addAddress($bio->email_address);
        // $mail->addCC($config['email']);

        //Content
        $mail->isHTML(true);                                  //Set email format to HTML
        $mail->Subject = $bio->email_subject;
        $mail->Body    = sprintf(
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top"><?php echo $bio->name; ?></a>
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img class="masthead-avatar mb-5" src="/storage/app/{{$bio->avatar}}" alt="..." />
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0"><?php echo $bio->job_title; ?></h1>
            <!-- Icon Divider-->
    ...
    <section class="page-section portfolio" id="portfolio">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <!-- Portfolio Item 1-->
                @foreach($bio->portfolio as $portfolio)
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal<?php echo $portfolio->id;?>">
                        <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                            <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
                        </div>
                        <img class="img-fluid" src="/storage/app/{{$portfolio->img}}" alt="..." />
                    </div>
                </div>
                @endforeach
            </div>
    ...
    <!-- Portfolio Modals-->
    @foreach($bio->portfolio as $portfolio)
    <!-- Portfolio Modal <?php echo $portfolio->id;?>-->
    <div class="portfolio-modal modal fade" id="portfolioModal<?php echo $portfolio->id;?>" tabindex="-1" aria-labelledby="portfolioModal<?php echo $portfolio->id;?>" aria-hidden="true">
